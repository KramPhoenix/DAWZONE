            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('pregunta') is-invalid @enderror" placeholder="Nombre de la categoría" name="pregunta" value="{{ old('pregunta') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('respuesta') is-invalid @enderror" placeholder="Nombre de la categoría" name="respuesta" value="{{ old('respuesta') }}">
